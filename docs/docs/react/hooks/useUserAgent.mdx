...
**[ua-parser-js](https://github.com/faisalman/ua-parser-js)** 를 활용해서 `window.navigator.userAgent` 정보를 분석하고 파싱한 데이터를 반환하는 커스텀 훅입니다.

<br />

## Code
[🔗 실제 구현 코드 확인](https://github.com/modern-agile-team/modern-kit/blob/main/packages/react/src/hooks/useUserAgent/index.ts)
