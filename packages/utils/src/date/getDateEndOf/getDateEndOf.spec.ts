...
describe('getDateEndOf', () => {
  ...
  describe('로컬 시간 기준', () => {
    it('year - 해당 연도의 12월 31일 23시 59분 59초를 반환한다', () => {
      ...
      expectLocalDateTime(result, '2025-12-31T14:59:59.999Z', 2025, 11, 31, 3);
    });

    it('month - 해당 월의 마지막 날 23시 59분 59초를 반환한다', () => {
      const result = getDateEndOf(testDate, 'month'); // 2025-03-31 23:59:59.999 (월요일)
      expectLocalDateTime(result, '2025-03-31T14:59:59.999Z', 2025, 2, 31, 1);
    });
    ...
    it('week - 해당 주의 마지막 날(토요일) 23시 59분 59초를 반환한다', () => {
      ...
      expectLocalDateTime(result, '2025-03-15T14:59:59.999Z', 2025, 2, 15, 6);
    });
  ...
  describe('UTC 기준', () => {
    it('utcYear - UTC 기준 해당 연도의 12월 31일 23시 59분 59초를 반환한다', () => {
      ...
      expectUTCDateTime(result, '2025-12-31T23:59:59.999Z', 2025, 11, 31, 3);
    });

    it('utcMonth - UTC 기준 해당 월의 마지막 날 23시 59분 59초를 반환한다', () => {
      const result = getDateEndOf(testDate, 'utcMonth'); // 2025-03-31 23:59:59.999 (월요일)
      expectUTCDateTime(result, '2025-03-31T23:59:59.999Z', 2025, 2, 31, 1);
    });
    ...
    it('utcWeek - UTC 기준 해당 주의 마지막 날(토요일) 23시 59분 59초를 반환한다', () => {
      ...
      expectUTCDateTime(result, '2025-03-15T23:59:59.999Z', 2025, 2, 15, 6);
    });
  ...
  describe('월 경계 처리', () => {
    it('월의 마지막 날에서 주의 끝점을 구할 때 다음 월로 넘어갈 수 있다', () => {
      ...
      expectLocalDateTime(result, '2025-04-05T14:59:59.999Z', 2025, 3, 5, 6);
    });
    ...
    it('연의 마지막 날에서 주의 끝점을 구할 때 다음 년으로 넘어갈 수 있다', () => {
      ...
      expectLocalDateTime(result, '2025-01-04T14:59:59.999Z', 2025, 0, 4, 6);
    });
  });
  ...
  describe('윤년 처리', () => {
    it('윤년의 2월 마지막 날을 올바르게 처리한다', () => {
      ...
      expectLocalDateTime(result, '2024-02-29T14:59:59.999Z', 2024, 1, 29, 4);
    });
    ...
    it('평년의 2월 마지막 날을 올바르게 처리한다', () => {
      ...
      expectLocalDateTime(result, '2025-02-28T14:59:59.999Z', 2025, 1, 28, 5);
    });
  });
